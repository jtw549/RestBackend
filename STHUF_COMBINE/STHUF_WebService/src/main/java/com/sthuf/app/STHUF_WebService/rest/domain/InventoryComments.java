...
import com.sthuf.app.STHUF_Business.events.Comments.CommentsDetails;
...
public class InventoryComments implements Serializable{
	...
	private ArrayList<com.sthuf.app.STHUF_Domain.domain.InventoryComments> inventoryCommentsList;
	...
	public ArrayList<com.sthuf.app.STHUF_Domain.domain.InventoryComments> getInventoryCommentsList() {
		return inventoryCommentsList;
	}

	public void setInventoryCommentsList(
			ArrayList<com.sthuf.app.STHUF_Domain.domain.InventoryComments> inventoryCommentsList) {
